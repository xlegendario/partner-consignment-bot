...
const {
  ...
  FIELD_OFFERS_ORDER_ID_ALT   = "Order",
...
export async function logOfferMessage({
  ...
  try {
    ...
    // Write to alternate order column too, if you have one.
    if (FIELD_OFFERS_ORDER_ID_ALT) fields[FIELD_OFFERS_ORDER_ID_ALT] = orderRecId;
